...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[MAC_QWERTY] = LAYOUT_ansi_1u(
            TG(WIN_QWERTY),   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  RESET,   KC_INS,  KC_DEL, 
            ...
            KC_LCTL, KC_LALT, KC_LGUI, LT(MAC_VIM, KC_SPC),       TO(MAC_VIM),      KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
        ),
    // Windows Layuout
	[WIN_QWERTY] = LAYOUT_ansi_1u(
            ...
            _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
            _______, _______, _______, LT(WIN_VIM, KC_SPC),       TO(WIN_VIM),      _______, _______, _______, _______, _______
        ),
    // MAC VIM Layout
	[MAC_VIM] = LAYOUT_ansi_1u(
            ...
            KC_NO,   KC_PGDN, KC_NO,   KC_BSPC, KC_PGUP, KC_NO,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO,   KC_NO,   KC_NO,   KC_NO,   
