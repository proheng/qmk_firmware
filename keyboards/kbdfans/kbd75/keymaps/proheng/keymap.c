...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_LGUI] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, gui_finished, gui_reset),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[MAC_QWERTY] = LAYOUT_ansi_1u(
            ...
            KC_LCTL, KC_LALT, TD(TD_LGUI),      LT(MAC_VIM, KC_SPC),       TD(TD_FN),   KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
        ),
    // Windows Layuout
