...
const rgblight_segment_t PROGMEM my_layer2_layer[] = RGBLIGHT_LAYER_SEGMENTS( {1, 16, HSV_ORANGE} );
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_ansi_1u(
            ...
            KC_LCTL, KC_LALT, KC_LGUI, LT(2,KC_SPC),     VIM_ON  ,KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
        ),
    // Windows Layuout
	[1] = LAYOUT_ansi_1u(
	...
	[2] = LAYOUT_ansi_1u(
            ...
            KC_NO,   KC_NO,   KC_NO,   KC_NO,   VIM_OFF, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO
            )
};
