 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  LCTL(KC_TAB), TG(_FUNC), LCTL_T(KC_SPC), MT(MOD_LCTL | MOD_LSFT, KC_ENT),      MT(MOD_RCTL | MOD_RALT, KC_ENT), LT(1,KC_BSPC), KC_BSPC, TG(_NUM)
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |   [  |  ]   |  \   |
...
[_LOWER] = LAYOUT(
  ...
  KC_LSFT, XXXXXXX, KC_DEL,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_MOUSE_WHEEL_LEFT, QK_MOUSE_WHEEL_RIGHT, KC_PIPE,
...
[_NUM] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     KC_7, KC_8, KC_9, KC_MINS, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     KC_4, KC_5, KC_6, KC_PLUS, XXXXXXX,XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,  KC_1, KC_2, KC_3, KC_EQL,  XXXXXXX,XXXXXXX, 
...
[_FUNC] = LAYOUT(
  ...
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,                   KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_HOME, KC_END,
  KC_LSFT, XXXXXXX, KC_DEL,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_MOUSE_WHEEL_LEFT, QK_MOUSE_WHEEL_RIGHT, KC_PIPE,
                             XXXXXXX, KC_TRNS, KC_LCTL, MT(MOD_LCTL | MOD_LSFT, KC_ENT),      MT(MOD_RCTL | MOD_RALT, KC_ENT),  XXXXXXX, XXXXXXX, XXXXXXX
)
};
...
//         if (!clockwise) {
//             tap_code16(X_MS_WH_DOWN);
//         } else {
//             tap_code16(X_MS_WH_UP);
//         }
